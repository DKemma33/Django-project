...
- 내 페이지:
  -  회원 정보 작성/수정
- 과외 목록:
  - 최근 게시글 목록 5개 단위로 조회하여 페이징 처리
  - 임시저장 버튼 클릭 시 임시 저장 목록 출력
  - 검색 기능 지원
  - 체크박스를 통한 목록 삭제 기능
...
## ✨ 프로젝트에서 느낀점
   ...
   특히, Git 충돌이 발생하거나 어려움을 겪을 때, 팀원들이 모여서 함께 문제를 고민하고 해결책을 찾아 나아가는 과정은 정말 중요하고 가치있는 경험이었습니다.  
   함께 노력하고 협력하면서, 처음에는 어려웠던 프로젝트를 팀으로서 성공적으로 완료할 수 있었습니다.
   
   이 경험을 통해 프로젝트가 어떻게 진행되는지, 팀원들과 어떻게 소통해야 하는지에 대해서 큰 깨달음을 얻었고, 어떤 부분이 개선이 필요한지를 돌아보는 시간이었습니다. 
   다음 프로젝트에서는 이 경험을 바탕으로 더 발전있는 모습으로 다음 프로젝트에 임하겠습니다
